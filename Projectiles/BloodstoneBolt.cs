	...
	public class BloodstoneBolt : ModProjectile {
		...
		public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone) {
			for (int i = 0; i < 4; i++) {
				...
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position, new Vector2(speedX, speedY), Mod.Find<ModProjectile>("BloodstoneShard").Type, (int)(Projectile.damage * 0.2), 0f, Projectile.owner, 0f, 0f);
			}
			Projectile.Kill();
		}
