...
namespace Singularity.Projectiles {
	public class JadeBolt : ModProjectile {
		...
		public override void AI() {
			...
			Dust dust = Dust.NewDustPerfect(dustPosition, 269, null, 100, default(Color), 1.2f);
			dust.velocity *= 0.1f;
			dust.noGravity = true;
			Vector2 dustPosition2 = projectile.Center + new Vector2(Main.rand.Next(-4, 4), Main.rand.Next(-4, 4));
			Dust dust2 = Dust.NewDustPerfect(dustPosition2, 57, null, 100, default(Color), 1.6f);
        ...
        public override void Kill(int timeLeft) {
            for (int i = 0; i < 3; i++) {
                ...
                float posY = projectile.position.Y * Main.rand.NextFloat(1f, 1f) + Main.rand.NextFloat(-2f, 2f);
	            ...
	            Projectile.NewProjectile(posX, posY, speedX, speedY, 228, (int)(projectile.damage * 0.7f), 0f, projectile.owner, 0f, 0f);
	        }
        }
	}
}