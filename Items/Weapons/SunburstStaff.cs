...
namespace Singularity.Items.Weapons
{
    ...
    public class SunburstStaffSunburst : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
		{
			if (!spawned) {
				for (int k = 0; k < 25; k++)
				{
					int dust = Dust.NewDust(Projectile.position + Projectile.velocity, 30, 30, 6, 0, 0, 0, default(Color), 2);
					Main.dust[dust].noGravity = true; //Disable the dust gravity.
					Main.dust[dust].velocity *= 1.5f; //Dust velocity.
				}
				spawned = true;
            }
			return false;
        ...
        public override void AI()
		{
            ...
            if (timer > 120){
				...
				int type = Mod.Find<ModProjectile>("SunburstBolt").Type; //The type of projectile the sentry will shoot. Use ModContent.ProjectileType<>() to fire a modded projectile.
				if (Main.myPlayer == Projectile.owner) {
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, 0, FireVelocity, type, damage, 3, Projectile.owner);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, FireVelocity * 0.966f, FireVelocity * 0.259f, type, damage, 3, Projectile.owner);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, FireVelocity * 0.866f, FireVelocity * 0.5f, type, damage, 3, Projectile.owner);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, FireVelocity * 0.707f, FireVelocity * 0.707f, type, damage, 3, Projectile.owner);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, FireVelocity * 0.5f, FireVelocity * 0.866f, type, damage, 3, Projectile.owner);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, FireVelocity * 0.259f, FireVelocity * 0.966f, type, damage, 3, Projectile.owner);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, FireVelocity, 0, type, damage, 3, Projectile.owner);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, FireVelocity * 0.966f, FireVelocity * -0.259f, type, damage, 3, Projectile.owner);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, FireVelocity * 0.866f, FireVelocity * -0.5f, type, damage, 3, Projectile.owner);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, FireVelocity * 0.707f, FireVelocity * -0.707f, type, damage, 3, Projectile.owner);
					Projectile.NewProjectile(Projectile.GetSource_FromThis(),Projectile.Center.X - 4f, Projectile.Center.Y, FireVelocity * 0.5f, FireVelocity * -0.866f, type, damage, 3, Projectile.owner);
