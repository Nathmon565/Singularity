...
namespace Singularity.Items.Weapons
{
	public class SharpshootersCrossbow : ModItem
	{
		...
		public override void SetDefaults() {
			Item.damage = 900; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
			Item.crit = 36;
		...
		public override void AddRecipes()
				{
					...
					recipe.AddIngredient(null, "MarksmansCrossbow", 1);
