...
namespace Singularity.Tiles
{
	public class EnchantedOre : ModTile
	{
		public override void SetStaticDefaults()
		{
			...
			DustType = 84;
			ItemDrop/* tModPorter Note: Removed. Tiles and walls will drop the item which places them automatically. Use RegisterItemDrop to alter the automatic drop if necessary. */ = ModContent.ItemType<Items.Placeable.EnchantedOre>();
